...
@section('content')
    <div class="container py-4">
        ...
        <form method="GET" action="{{ route('admin.annonces.index') }}"
            class="mb-4 d-flex gap-3 align-items-center flex-wrap">
            ...
            <input type="text" name="search" placeholder="Recherche titre ou localisation" value="{{ $search ?? '' }}"
                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                @if ($annonce->image)
                                    ...
                                    @endif
                                @else
                                    <img src="{{ asset('images/default.png') }}" alt="Pas d'image"
                                        style="width: 100px; height: 70px; object-fit: cover;">
                                @endif
                            </td>
                                    ...
                                    @if ($annonce->statut === 'en_attente')
                                        <form action="{{ route('admin.annonces.update', $annonce) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-outline-success btn-sm"
                                                onclick="return confirm('Valider cette annonce ?')" title="Valider">
                                        ...
                                        <form action="{{ route('admin.annonces.update', $annonce) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-outline-danger btn-sm"
                                                onclick="return confirm('Rejeter cette annonce ?')" title="Rejeter">
